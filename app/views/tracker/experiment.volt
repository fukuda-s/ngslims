{{ content() }} {% for step in steps %} {% if loop.first %}
  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      <div class="row">
        ...
        <div class="col-md-2">
          <a class="glyphicon glyphicon-plus pull-right" data-toggle="collapse" data-target="#addNewExperimentStep" href="#"></a>
        </div>
      </div>
    </div>
      ...
      <div class="panel-heading" id="StepList">
        <h4 class="panel-title">
          <div class="row">
            ...
            <div class="col-md-2">
              <a rel="tooltip" data-placement="right" data-original-title="Configure Experiment Step"> <i class="glyphicon glyphicon-pencil pull-right"></i>
              </a>
            </div>
          </div>
        </h4>
...
{% endif %} {% else %} No experiments are recorded {% endfor %}
