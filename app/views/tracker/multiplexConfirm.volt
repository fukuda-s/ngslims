...
<form class="form-horizontal" role="form" action="{{ url("tracker/multiplexSave/" ~ step_id ) }}" method="POST">
    ...
    <div class="panel panel-default">
      ...
      {% for selected_seqlib in selected_seqlibs[selected_seqtemplate_index] %}
        {% if loop.first %}
          <div class="panel-body">
            ...
            <div class="form-group">
              ...
              <label for="added_dw_vol-{{ selected_seqtemplate_index }}" class="col-sm-2 control-label">Actual Added DW
                (uL)</label>
              <div class="col-sm-2">
        ...
        <tr id="seqlib-{{ seqlib.id }}">
          ...
          <td><input type="text" id="seqlib_conc_factor-{{ seqlib.id }}" name="seqlib_conc_factor-{{ seqlib.id }}" value="1.000">
          </td>
  ...
  {% endfor %}
  <div class="row">
    {{ submit_button("Save", "class": "btn btn-success btn-large pull-right") }}
  </div>
</form>
<script>
