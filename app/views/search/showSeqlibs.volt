  ...
  */
  ...
  $container.handsontable({
    ...
    columns: [
      ...
      { data: "sl.started_at", title: "Started Date", editor: false, type: 'date', dateFormat: 'YYYY-MM-DD' },
      { data: "sl.finished_at", title: "Finished Date", editor: false, type: 'date', dateFormat: 'YYYY-MM-DD' },
