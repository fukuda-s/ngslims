  ...
  */
  ...
  $container.handsontable({
    ...
    columns: [
      ...
      { data: "sl.protocol_id", title: "Protocol", readOnly: true, type: "dropdown", /* source: protocolDrop, */ renderer: protocolRenderer },
      { data: "sl.oligobarcodeA_id", title: "OligoBarcode A", readOnly: true, type: "dropdown", /* source: oligobarcodeADrop, */ renderer: oligobarcodeARenderer },
      { data: "sl.oligobarcodeB_id", title: "OligoBarcode B", readOnly: true, type: "dropdown", /* source: oligobarcodeBDrop, */ renderer: oligobarcodeBRenderer },
